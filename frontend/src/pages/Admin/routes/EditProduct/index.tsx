...
const EditProductPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-8 pb-16">
      ...
      {error && (
        <div className="bg-[#fdf0ed] text-[#9c2b20] border border-[#f7c7c0] p-4 rounded-[16px] text-[14px] font-medium">
          {error}
        </div>
      )}

      <form onSubmit={handleSaveAllChanges} className="flex flex-col gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <Card className="p-8 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                ...
                <Button type="button" variant="outline" onClick={addNewVariantBox}>
                  + Thêm biến thể mới
                </Button>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                      ...
                      <div className="flex flex-col gap-2 md:col-span-6">
                        ...
                        <Input
                          ...
                          required
                        />
                        {Number(v.costPrice) >= Number(v.price) && (
                ...
                {newVariants.map((v, i) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                      ...
                      <div className="flex flex-col gap-2 md:col-span-6">
                        ...
                        <Input
                          ...
                          required
                        />
                        {Number(v.costPrice) >= Number(v.price) && (Number(v.costPrice) > 0 || Number(v.price) > 0) && (
                          <p className="text-[12px] text-[#9c2b20] font-medium">
                            Giá gốc (giá nhập) phải nhỏ hơn giá bán.
                          </p>
                        )}
                    ...
                    <div className="flex justify-end">
                      <Button type="button" variant="primary" onClick={() => saveNewVariant(i)}>
                        Tạo biến thể
                      </Button>
                    </div>
                  </div>
        ...
        {/* BOTTOM ACTION BAR: Nút Hủy (từ chối tất cả thay đổi) & Lưu tất cả thay đổi */}
        <div className="pt-8 border-t border-[#eeeee9] flex items-center justify-end gap-3">
          ...
          >
            {loading ? "Đang lưu tất cả..." : "Lưu tất cả thay đổi"}
          </Button>
        </div>
      </form>
    </div>
