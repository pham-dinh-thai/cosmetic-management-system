...
export class Migration20260904165135 extends Migration {
  ...
  override up(): void | Promise<void> {
    this.addSql(
      `create table "suppliers" ("id" uuid not null default gen_random_uuid(), "code" varchar(255) not null, "name" varchar(255) not null, "email" varchar(255) not null, "phone" varchar(255) null, "address" varchar(255) null, "is_active" boolean not null default true, "created_at" timestamptz not null, "updated_at" timestamptz not null, primary key ("id"));`,
    );
    this.addSql(
