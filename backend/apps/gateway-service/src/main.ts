...
const SERVICE_DOCS_SOURCES: ServiceDocsSource[] = [
  ...
  { name: 'categories', url: process.env.CATEGORY_SERVICE_URL },
  ...
  { name: 'audit-logs', url: process.env.AUDIT_SERVICE_URL },
...
async function bootstrap() {
  ...
  app.use(
    createProxyMiddleware({
      ...
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/categories(\/|$)/.test(pathname),
    }),
  );
  app.use(
    createProxyMiddleware({
      ...
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/suppliers(\/|$)/.test(pathname),
    }),
  );
  app.use(
    createProxyMiddleware({
      target: process.env.COSMETIC_SERVICE_URL,
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/cosmetics(\/|$)/.test(pathname),
    }),
  );
  app.use(
    createProxyMiddleware({
      target: process.env.STORAGE_SERVICE_URL,
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/uploads(\/|$)/.test(pathname),
    }),
  );
  app.use(
    createProxyMiddleware({
  ...
  app.use(
    createProxyMiddleware({
      ...
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/orders(\/|$)/.test(pathname),
    }),
  );
  app.use(
    createProxyMiddleware({
  ...
  app.use(
    createProxyMiddleware({
      target: process.env.BASKET_SERVICE_URL,
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/baskets(\/|$)/.test(pathname),
    }),
  );
  app.use(
    createProxyMiddleware({
      ...
      changeOrigin: true,
      pathFilter: (pathname) => /^\/api\/audit-logs(\/|$)/.test(pathname),
    }),
  );
